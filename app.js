...
const products = [
  ...
  // ══════════════ CARGADORES ══════════════
  {
    id: 13, name: 'Cargador 20W Apple', storage: 'Power Adapter', price: 25000,
    category: 'cargadores', badge: 'Nuevo',
    desc: 'El adaptador USB-C de 20W original Apple. Carga rapidísima para iPhone 8 o posterior: de 0 a 50% en solo 30 minutos. Compatible con iPad Pro, iPad Air, iPad mini y casi cualquier dispositivo USB-C moderno.',
    img: 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MHJA3?wid=1144&hei=1144&fmt=jpeg&qlt=95',
    imgs: ['https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MHJA3?wid=1144&hei=1144&fmt=jpeg&qlt=95'],
    specs: [
      {
        section: 'Especificaciones', items: [
          { label: 'Potencia', value: '20W (máxima)' },
          { label: 'Puerto', value: 'USB-C (Type-C)' },
          { label: 'Entrada', value: '100–240V ~ 50/60Hz 0.5A (universal)' },
          { label: 'Salida', value: '9V/2.22A · 5.8V/3A · 5V/3A' },
          { label: 'Protocolo', value: 'USB Power Delivery 2.0' },
        ]
      },
      {
        section: 'Carga Rápida', items: [
          { label: 'iPhone', value: '0 → 50% en ~30 min (iPhone 8 o posterior)' },
          { label: 'iPad Pro', value: 'Carga rápida optimizada' },
          { label: 'MacBook Air', value: 'Carga lenta (no recomendada como principal)' },
        ]
      },
      {
        section: 'Compatibilidad', items: [
          { label: 'iPhone', value: 'iPhone 8 hasta iPhone 17 Pro Max' },
          { label: 'iPad', value: 'Todos los modelos con USB-C o Lightning' },
          { label: 'AirPods', value: 'AirPods Pro y AirPods Max' },
          { label: 'Apple Watch', value: 'No (requiere MagSafe)' },
        ]
      },
      {
        section: 'Diseño', items: [
          { label: 'Dimensiones', value: '45 × 45 × 25 mm' },
          { label: 'Peso', value: '47 g' },
          { label: 'Color', value: 'Blanco' },
          { label: 'Certificación', value: 'Original Apple — ICES-003 / CE / FCC' },
        ]
      },
    ],
  },
  {
    id: 14, name: 'Multi-port Charging Station', storage: '120W · 6 puertos', price: 45000,
    category: 'cargadores', badge: 'Nuevo',
    desc: 'Estación de carga definitiva para toda la familia. 6 puertos simultáneos: 2× USB-C con Power Delivery de hasta 45W + 4× USB-A con Quick Charge 3.0. Carga tu iPhone, iPad, MacBook, AirPods, Samsung y más al mismo tiempo.',
    img: 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MHXH3?wid=1144&hei=1144&fmt=jpeg&qlt=95',
    imgs: ['https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MHXH3?wid=1144&hei=1144&fmt=jpeg&qlt=95'],
    specs: [
      {
        section: 'Especificaciones', items: [
          { label: 'Potencia total', value: '120W máximos' },
          { label: 'Puerto USB-C 1', value: '45W Power Delivery 3.0' },
          { label: 'Puerto USB-C 2', value: '30W Power Delivery 3.0' },
          { label: 'Puertos USB-A × 4', value: '18W Quick Charge 3.0 c/u' },
          { label: 'Entrada', value: '100–240V ~ 50/60Hz (universal)' },
          { label: 'Protección', value: 'Sobrecarga, cortocircuito, sobrecalentamiento' },
        ]
      },
      {
        section: 'Compatibilidad', items: [
          { label: 'MacBook Pro', value: 'Carga hasta 45W (ideal M1/M2)' },
          { label: 'iPad Pro', value: 'Carga rápida compatible' },
          { label: 'iPhone / Android', value: 'Todos los modelos USB-C o Lightning (con cable)' },
          { label: 'AirPods / Watch', value: 'Sí — vía adaptador' },
        ]
      },
      {
        section: 'Diseño', items: [
          { label: 'Dimensiones', value: '95 × 57 × 30 mm' },
          { label: 'Peso', value: '210 g' },
          { label: 'Cable', value: '1.5m de longitud, nylon trenzado' },
          { label: 'LED', value: 'Indicador de encendido' },
        ]
      },
    ],
  },
